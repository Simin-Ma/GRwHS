...
from grwhs.models.grwhs_svi_numpyro import GRwHS_SVI_Numpyro
...
def test_grwhs_svi_numpyro_runs_and_produces_posterior_samples():
    X, y, groups, _ = _toy_dataset()

    with mock.patch("grwhs.models.grwhs_svi_numpyro.progress", lambda iterable, **_: iterable):
        model = GRwHS_SVI_Numpyro(c=1.5, tau0=0.2, eta=0.6, s0=1.0, num_steps=40, lr=5e-2, seed=2024)
