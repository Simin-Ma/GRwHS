...
from grwhs.models.grwhs_gibbs_logistic import GRwHS_Gibbs_Logistic
...
def test_grwhs_gibbs_logistic_runs_and_returns_probabilities():
    X, y, groups = _make_synthetic_logistic()

    model = GRwHS_Gibbs_Logistic(
        c=1.5,
        tau0=0.2,
        eta=0.6,
        s0=1.0,
