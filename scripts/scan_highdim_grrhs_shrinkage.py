...
DEFAULT_CANDIDATES = [
    ...
    {
        "label": "kappa_b12_tau05",
        "description": "kappa~Beta(0.5,12.0) with tau0 halved from the high-dimensional calibrated value",
        "alpha_kappa": 0.5,
        "beta_kappa": 12.0,
        "tau0": 0.00392837100659193,
    },
    {
        "label": "kappa_b16",
        "description": "very strong group shrinkage: kappa~Beta(0.5,16.0)",
        "alpha_kappa": 0.5,
        "beta_kappa": 16.0,
    },
    {
        "label": "kappa_b20",
        "description": "very strong group shrinkage: kappa~Beta(0.5,20.0)",
        "alpha_kappa": 0.5,
        "beta_kappa": 20.0,
    },
    {
        "label": "kappa_a025_b12",
        "description": "sharper spike near zero: kappa~Beta(0.25,12.0)",
        "alpha_kappa": 0.25,
        "beta_kappa": 12.0,
    },
    {
        "label": "kappa_a025_b16",
        "description": "sharper spike near zero with stronger shrinkage: kappa~Beta(0.25,16.0)",
        "alpha_kappa": 0.25,
        "beta_kappa": 16.0,
    },
    {
        "label": "kappa_b12_coef",
        "description": "kappa~Beta(0.5,12.0) with tau calibrated to active coefficients",
        "alpha_kappa": 0.5,
        "beta_kappa": 12.0,
        "tau_target": "coefficients",
    },
    {
        "label": "kappa_a025_b2",
