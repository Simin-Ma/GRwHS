...
OUT_DIR = ROOT / "outputs" / "figures" / "nhanes_gigg_mmle"
PNG_PATH = OUT_DIR / "nhanes_gigg_mmle_forest.png"
PDF_PATH = OUT_DIR / "nhanes_gigg_mmle_forest.pdf"
CSV_PATH = OUT_DIR / "nhanes_gigg_mmle_effect_summary.csv"
...
def _load_inputs() -> tuple[
    ...
    return x_scaled, x_log, y_z, y_log, c_model, groups, feature_codes, feature_labels, feature_groups
...
def _plot(
    *,
    ...
    ax.set_title("NHANES 2003-2004: GIGG-MMLE Exposure Effects", fontsize=14, pad=12, fontweight="bold")
    ax.text(
        0.0,
        1.01,
        "Posterior mean with 95% credible interval; fitted on log-transformed, standardized GGT and exposures",
...
def main() -> None:
    ...
    x_scaled, x_log, y_z, y_log, c_model, groups, feature_codes, feature_labels, feature_groups = _load_inputs()
