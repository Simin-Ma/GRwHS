...
from simulation_second.src.bayes_kernel.core.models.grrhs_nuts import calibrate_tau0


def _load_grrhs_classes():
    from simulation_second.src.bayes_kernel.core.models.grrhs_nuts import (
        GRRHS_CollapsedNUTS,
        GRRHS_Gibbs_Staged,
    )
