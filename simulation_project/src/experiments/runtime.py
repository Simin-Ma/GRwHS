...
KNOWN_METHODS = [*METHODS, "GR_RHS_EB", "GR_RHS_LowDim", "GR_RHS_HighDim", "RHS_LowDim", "RHS_HighDim", "RHS_Gibbs", "GIGG_MMLE_LowDim", "GIGG_MMLE_HighDim"]
EXP3_GIGG_MODES = ("paper_ref",)

_BAYESIAN_METHODS = {"GR_RHS", "GR_RHS_EB", "GR_RHS_LowDim", "GR_RHS_HighDim", "RHS", "RHS_LowDim", "RHS_HighDim", "RHS_Gibbs", "GIGG_MMLE", "GIGG_MMLE_LowDim", "GIGG_MMLE_HighDim", "GIGG_b_small", "GIGG_GHS", "GIGG_b_large", "GHS_plus"}
