...
def _ga_v2_correlation_worker(
    ...
    dataset_dir = ensure_dir(base_dir / "results" / "group_aware_v2" / "ga_v2_correlation_stress" / "datasets" / f"rep_{int(replicate_id):03d}")
    ...
    save_json(
        {
            ...
            "active_groups": [int(v) for v in active_groups],
