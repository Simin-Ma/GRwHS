...
@dataclass
class RegularizedHorseshoeRegression:
    """Regularized horseshoe regression with rstanarm-aligned Stan parameterization."""
    ...
    def _default_stan_file(self) -> Optional[Path]:
        ...
        return (Path(__file__).resolve().parent / "stan" / filename).resolve()
